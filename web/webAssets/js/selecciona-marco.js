...
$(document).ready(function(){
	...
	$('#selecciona-marco-btn').click(function(e){
		...
		if(marcoSeleccionado==0){
			l.stop();
		}
		
		marcoSeleccionado = $('.item.item-active').data('value'); 
		
		var fotografiaSeleccionada = $('#js-imagen-seleccionada').val();
		
		window.location = basePath+"site/registro?fs="+fotografiaSeleccionada+"&ms="+marcoSeleccionado;
	});
